...
% Works fine, accept for brain stem (brain stem nu ook) 
files = {'AX_1' 'AX_2' 'AX_3' 'AX_4' 'AX_5' 'COR_1' 'COR_2' 'COR_3' 'COR_4' 'COR_5' 'SAG_1' 'SAG_2' 'SAG_3' 'SAG_4' 'SAG_5'};
for i = 1:length(files);
   file = files{i};
   image = im2double(imread(fullfile('C:\Users\ehulst\surfdrive - Hulst, E. van (Ellen)@surfdrive.surf.nl\Overig\Courses\G2 Image processing\Assignment\AssignmentTrainingImages\',[file '.png'])));
